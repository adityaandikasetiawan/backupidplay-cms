...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    featured: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    is_national: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::article.article'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    regionals: Schema.Attribute.Relation<'oneToMany', 'api::regional.regional'>;
...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.String;
    interest: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::author.author'
...
export interface ApiNationalBannerNationalBanner
  extends Struct.CollectionTypeSchema {
  collectionName: 'national_banners';
  info: {
    displayName: 'Banner National';
    pluralName: 'national-banners';
    singularName: 'national-banner';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    altname: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    image: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    listNumber: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::national-banner.national-banner'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiProductBenefitProductBenefit
  ...
  attributes: {
    ...
    name: Schema.Attribute.String &
      ...
      Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<['umum', 'ott']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'umum'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    finalSpeedInMbps: Schema.Attribute.Integer &
      Schema.Attribute.Required &
    ...
    originalSpeedInMbps: Schema.Attribute.Integer;
    priceHint: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiRegionalBannerRegionalBanner
  extends Struct.CollectionTypeSchema {
  collectionName: 'regional_banners';
  info: {
    displayName: 'Banner Regional';
    pluralName: 'regional-banners';
    singularName: 'regional-banner';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    regional: Schema.Attribute.Relation<'oneToOne', 'api::regional.regional'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::national-banner.national-banner': ApiNationalBannerNationalBanner;
      ...
      'api::regional-banner.regional-banner': ApiRegionalBannerRegionalBanner;
